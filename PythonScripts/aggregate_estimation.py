...
estimation_out = os.path.join(TABDIR,"estimation_"+MODALITY+'_'+ADAPTIVE+'_'+EXC+'_'+MODEL+'_'+str(PILOT)+'.csv')
prediction_out = os.path.join(TABDIR,"prediction_"+MODALITY+'_'+ADAPTIVE+'_'+EXC+'_'+MODEL+'_'+str(PILOT)+'.csv')
true_out = os.path.join(TABDIR,"true_"+MODALITY+'_'+ADAPTIVE+'_'+EXC+'_'+MODEL+'_'+str(PILOT)+'.csv')
conditional_out = os.path.join(TABDIR,"conditional_"+MODALITY+'_'+ADAPTIVE+'_'+EXC+'_'+MODEL+'_'+str(PILOT)+'.csv')
